...
function App() {
  const hotelData = {
    id: "3faf8507-307f-4846-936c-a1465b3cfc42",
    name: "Royal Palm Beach Resort [SANDBOX]",
    currency: "ANG",
    starRating: 3.4,
    description: {
      short:
        "How would you like to spend a week or longer with a beautiful, white sandy beach right at your doorstep? You can, when you stay at Royal Palm Beach Resort on Saint Martin/Saint Maarten in the Caribbean. Just imagine strolling along the gorgeous beach, swimming in the sparkling blue waters, and just relaxing by the pool at the resort.  If you are looking for the ultimate in relaxing vacations, you will find it at Royal Palm Beach Resort.",
    },
    price: 1499,
    details: "4 guests . 2 bedroom . 1 bed . 1 bathroom",
    review: "342",
    liked: true,
    phoneNumbers: ["888.249.8810"],
    emails: [
