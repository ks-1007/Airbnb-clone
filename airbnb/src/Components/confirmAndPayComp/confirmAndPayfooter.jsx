...
import styles from "./Css/confirmAndPayfooter.module.css";
export const ConfirmAndPayFooter = () => {
  return (
    <footer className={styles._footer}>
      <div className={styles._1s94zl78}>
        <div className={styles._157uib4}>
          <section>
            <div className={styles._ar9stc}>
              <div className={styles._pd8gea}>
                <div className={styles._wjo0ey}>
                  <div className={styles._1br4kkl}>
                    © 2021 Airbnb, Inc.
                  </div>
                  <div className={styles._opoa3c}>
                    <span className={styles._j8ldew}>
                      <span className={styles._10wqwyj}>
                        ·
                      </span>
                    </span>
                    <NavLink className={styles._o06542u} to="#">
                      Privacy
                    </NavLink>
                    <span className={styles._10wqwyj}>
                      ·
              ...
              <div className={styles._jro6t0}>
                <div className={styles._jro6t0}>
                  <span className={styles._19c5bku}>
                    <button className={styles._108vr8f6}>
                      ...
                      <span className={styles._bjxj6b}>English (IN)</span>
                    </button>
                  </span>
                  <span className={styles._19c5bku}>
                    <button  className={styles._108vr8f6}>
                      <span className={styles._14tkmhr}>₹</span>
                      <span className={styles._bjxj6b}>INR</span>
                    </button>
                  </span>
                </div>
                <div className={styles._xh0r19}>
                  <ul className={styles._115qwnm}>
                    <li className={styles._kdkpwk}>
                      <NavLink
                        className={styles._s7cvp1u}
                        to="#"
                      >
                        <svg
                          viewBox="0 0 32 32"
